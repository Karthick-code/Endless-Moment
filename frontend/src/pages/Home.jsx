...
//           >
//             ENDLESS Moments. <br />
//             {/* <span className="font-serif italic font-normal text-[#D4AF37]">Capture your moments</span> */}
//           </motion.h1>
...
//           >
//             Professional photography and cinematic storytelling for the moments you want to keep forever.
//           </motion.p>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`relative p-6 bg-[#141414] border rounded-sm transition-colors duration-300 ${
                  isOpen
                    ? "border-[#D4AF37]/70"
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <h3 className="text-base font-serif italic text-gray-100 tracking-wide">
                      {service.title}
                    </h3>
                    <span
                      className={`text-[#D4AF37] text-lg leading-none transition-transform duration-200 ${
                        isOpen ? "rotate-45" : ""
                      }`}
                      aria-hidden="true"
                    >
                ...
                {isOpen && (
                  <motion.div
                    ...
                    className="mt-5 pt-4 border-t border-[#2A2A2A] grid grid-cols-1 gap-2"
                  >
                    <Link
                      to={`/contact?service=${encodeURIComponent(service.slug)}`}
                      className="flex items-center justify-between px-4 py-3 bg-[#D4AF37] text-black rounded-sm text-[10px] font-bold uppercase tracking-wider hover:bg-[#c49f2a] transition-colors"
                    >
